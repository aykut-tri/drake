...
gym.envs.register(id="IiwaBoxPushing-v0",
                  entry_point="envs.iiwa_pushing_box:IiwaBoxPushingEnv")
...
zip = "/home/josebarreiros/rl/data/IiwaBoxPushing_ppo_{observations}.zip"
log = "/home/josebarreiros/rl/tmp/IiwaBoxPushing/"
checkpoint_callback = CheckpointCallback(save_freq=20000, save_path='/home/josebarreiros/rl/tmp/IiwaBoxPushing/model_checkpoints/')
debug=args.debug #True

if __name__ == '__main__':
    num_cpu = 12 if not args.test else 2
    if not args.train_single:
        env = make_vec_env("IiwaBoxPushing-v0",
                        n_envs=num_cpu,
                        seed=0,
        ...
        env = gym.make("IiwaBoxPushing-v0", meshcat=meshcat, 
