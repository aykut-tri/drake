...
gym.envs.register(id="Noodleman_fbase_StandUpPID-v0",
                  entry_point="envs.noodleman_fbase_standup_pid:NoodlemanStandUpEnv")
...
zip = "/home/josebarreiros/rl/data/noodleman_fbase_StandUpPID_ppo_{observations}.zip"
log = "/home/josebarreiros/rl/tmp/noodleman_fbase_StandUpPID/"
checkpoint_callback = CheckpointCallback(save_freq=20000, save_path='/home/josebarreiros/tmp/noodleman_fbase_StandUpPID/model_checkpoints/')
debug=True
...
if __name__ == '__main__':
    ...
    if not debug:
        ...
        env = gym.make("Noodleman_fbase_StandUpPID-v0", meshcat=meshcat, 
